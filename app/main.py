...
def create_app() -> FastAPI:
    ...
    app.include_router(arrendatario_routes.router, prefix=f"{api_prefix}/arrendatarios")
    ...
    async def validation_exception_handler(request: Request, exc: RequestValidationError):
        ...
        for error in exc.errors():
            ...
            input_value = error.get("input", None)  # 'input' podría no estar presente en todos los casos
